      ...
      <section className={s.mainSection}>
        <div className={s.headerFlex}>
          <div>
            ...
            <p className={s.subtitle}>Save the overdue fine rule here. After saving, use the edit icon to update it again
            </p>
            </div>
          ...
          <form className={s.formContainer} onSubmit={handleSubmit}>
            <label className={s.label}>
              ...
              <input type="number" min="0" value={form.amount} onChange={(event) =>
              setForm((current) => ({
                ...current,
            ...
            <label className= {s.label}>
              ...
              <select value={form.interval} onChange={(event) => 
                setForm((current) => ({
                  ...current,
