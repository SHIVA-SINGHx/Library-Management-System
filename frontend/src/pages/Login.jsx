...
const Login = () => {
  ...
  const [shoowPassword, setShowPassword] = useState(false);
  ...
  }, [location.state]); // to see the filed input
          ...
          <div className={s.infoBoxesContainer}>
            <div className={s.infoBox}>
              ...
              <p className={s.infoBoxText}>
                ...
                to test student funcitionality with real data.
              </p>
            </div>
            <div className={s.infoBox}>
              <p className={s.infoBoxTitle}>
          ...
          <div className={s.formInner}>
            ...
            <form className={s.form} onSubmit={handleSubmit}>
              ...
              <label className="block">
                ...
                <button type="button" onClick={()=> setShowPassword((current)=> !current)} className={s.togglePasswordButton}>
                    {shoowPassword ? <EyeOff size={17}/> : <Eye size={17}/>}
                </button>
